...
<h2>Instruktioner</h2>
<p>
    För att validera en ip-adress (IPv4 eller IPv6), POST:a till <code>/ip-validering2/api</code> med ip-adressen i body-parametern "ip".
</p>
...
<form class="form" method="POST" action="<?= url("ip-validering2/api") ?>">
